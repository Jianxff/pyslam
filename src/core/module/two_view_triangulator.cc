...
#include "core/solve/triangulator.h"
...
namespace PLSLAM
{
    namespace module
    {
        ...
        bool two_view_triangulator::triangulate(const unsigned idx_1, const unsigned int idx_2, Vec3_t &pos_w) const
        {
            ...
            if (!check_depth_is_positive(pos_w, rot_1w_, trans_1w_, camera_1_) || !check_depth_is_positive(pos_w, rot_2w_, trans_2w_, camera_2_))
            {
                return false;
            }
