...
#ifndef PLSLAM_TRACKING_MODULE_H
#define PLSLAM_TRACKING_MODULE_H

#include "core/type.h"
#include "core/data/frame.h"
#include "core/module/initializer.h"
#include "core/module/relocalizer.h"
#include "core/module/keyframe_inserter.h"
#include "core/module/frame_tracker.h"
...
namespace PLSLAM
{
    ...
    public:
        ...
        //! last tracking state
        tracker_state_t last_tracking_state_ = tracker_state_t::Initializing;
...
#endif // PLSLAM_TRACKING_MODULE_H
