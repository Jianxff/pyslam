...
#include "core/mapping_module.h"
#include "core/global_optimization_module.h"
#include "core/camera/base.h"
#include "core/data/camera_database.h"
#include "core/data/map_database.h"
#include "core/data/bow_database.h"
#include "core/io/trajectory_io.h"
#include "core/io/map_database_io.h"
#include "core/publish/map_publisher.h"
#include "core/publish/frame_publisher.h"
#include "core/optimize/global_bundle_adjuster.h"
...
namespace PLSLAM
{
    ...
    void system::startup(const bool need_initialize)
    {
        ...
        mapping_thread_ = std::unique_ptr<std::thread>(new std::thread(&PLSLAM::mapping_module::run, mapper_));
        global_optimization_thread_ = std::unique_ptr<std::thread>(new std::thread(&PLSLAM::global_optimization_module::run, global_optimizer_));
    }
