...
#ifndef PLSLAM_OPTIMIZE_G2O_SE3_POSE_OPT_EDGE_WRAPPER_H
#define PLSLAM_OPTIMIZE_G2O_SE3_POSE_OPT_EDGE_WRAPPER_H

#include "core/camera/perspective.h"
#include "core/camera/fisheye.h"
#include "core/camera/equirectangular.h"
#include "core/optimize/g2o/se3/perspective_pose_opt_edge.h"
#include "core/optimize/g2o/se3/equirectangular_pose_opt_edge.h"

#include <g2o/core/robust_kernel_impl.h>

// FW:
#include "core/optimize/g2o/se3/pose_opt_edge_line3d_orthonormal.h" // orthonormal representation
        ...
        namespace g2o
        {
            namespace se3
            {
                      ...
                      is_monocular_(obs_x_right < 0)
                {
                    ...
                    // define a reprojection edge (Unary)
                    auto edge = new PLSLAM::optimize::g2o::se3::pose_opt_edge_line3d();
...
#endif // PLSLAM_OPTIMIZE_G2O_SE3_POSE_OPT_EDGE_WRAPPER_H
