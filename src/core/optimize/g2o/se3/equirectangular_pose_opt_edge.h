...
#ifndef PLSLAM_OPTIMIZER_G2O_SE3_EQUIRECTANGULAR_POSE_OPT_EDGE_H
#define PLSLAM_OPTIMIZER_G2O_SE3_EQUIRECTANGULAR_POSE_OPT_EDGE_H
...
#endif // PLSLAM_EQUIRECTANGULAR_POSE_OPT_EDGE_H
