...
#ifndef PLSLAM_OPTIMIZE_G2O_SE3_REPROJ_EDGE_WRAPPER_H
#define PLSLAM_OPTIMIZE_G2O_SE3_REPROJ_EDGE_WRAPPER_H

#include "core/camera/perspective.h"
#include "core/camera/fisheye.h"
#include "core/camera/equirectangular.h"
#include "core/optimize/g2o/se3/perspective_reproj_edge.h"
#include "core/optimize/g2o/se3/equirectangular_reproj_edge.h"
#include <g2o/core/robust_kernel_impl.h>

// FW:
#include "core/data/landmark_line.h"
#include "core/optimize/g2o/line3d.h"
#include "core/optimize/g2o/se3/reproj_edge_line3d_orthonormal.h" // orthonormal representation
        ...
        namespace g2o
        {
            namespace se3
            {
                      ...
                      is_monocular_(true)
                {
                    ...
                    // create a reprojection error edge (Binary)
                    auto edge = new PLSLAM::optimize::g2o::se3::reproj_edge_line3d();
                ...
                {
                    return static_cast<PLSLAM::optimize::g2o::se3::reproj_edge_line3d *>(edge_)->PLSLAM::optimize::g2o::se3::reproj_edge_line3d::depth_is_positive_via_endpoints_trimming();
                }
            }
        }
    }
