...
#ifndef PLSLAM_OPTIMIZER_G2O_EXTENDED_PLANE_POINT_EDGE_WRAPPER_H
#define PLSLAM_OPTIMIZER_G2O_EXTENDED_PLANE_POINT_EDGE_WRAPPER_H

#include "core/optimize/g2o/extended/plane_point_distance_edge.h"
