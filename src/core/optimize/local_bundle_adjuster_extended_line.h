...
#ifndef PLSLAM_OPTIMIZE_LOCAL_BUNDLE_ADJUSTER_EXTENDED_LINE_H
#define PLSLAM_OPTIMIZE_LOCAL_BUNDLE_ADJUSTER_EXTENDED_LINE_H
...
#endif // PLSLAM_OPTIMIZE_LOCAL_BUNDLE_ADJUSTER_H
