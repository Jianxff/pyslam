...
namespace pangolin_viewer
{
    ...
    public:
         ...
         * @param map_publisher
         */
        viewer(const std::shared_ptr<PLSLAM::config> &cfg, PLSLAM::system *system,
    ...
    private:
        ...
        void draw_dense_pointcloud(PLSLAM::data::keyframe *kf);
         ...
         * @param width
         */
        void draw_camera(const PLSLAM::Mat44_t &cam_pose_wc, const float width) const;
        ...
        //! system
        PLSLAM::system *system_;
        //! frame publisher
        const std::shared_ptr<PLSLAM::publish::frame_publisher> frame_publisher_;
        //! map publisher
